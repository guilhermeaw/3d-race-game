    ...
    <Sampler>
      ...
      {checkpoints.map((checkpoint) => (
        <Checkpoint
          key={checkpoint.id}
          {...checkpoint.position}
          firstCheck={checkpoint.firstCar}
          secondCheck={checkpoint.secondCar}
        />
      ))}
